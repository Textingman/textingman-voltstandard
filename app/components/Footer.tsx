...
export default function Footer() {
  return (
    <footer className="text-white py-12" style={{ backgroundColor: '#1A1A1A' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Volt Standard</h3>
            <p style={{ color: '#CBD5E1' }}>
              Internal transactional messaging for modern businesses.
            </p>
            {/* Social Icons */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/signup" style={{ color: '#CBD5E1' }} className="hover:text-white">Get Started</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <p style={{ color: '#CBD5E1' }}>support@voltstandard.com</p>
            <p className="mt-2" style={{ color: '#CBD5E1' }}>350 Fifth Avenue, Ste 4100, New York, NY 10118</p>
            <p className="mt-2" style={{ color: '#CBD5E1' }}>(877) 514-3629</p>
          </div>
        </div>
        <div className="mt-8 pt-8 text-center" style={{ borderTop: '1px solid #1A1A1A', color: '#CBD5E1' }}>
          <p>&copy; 2026 Volt Standard. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
